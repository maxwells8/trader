...
server.set("max_c", 1.5)

server.set("actor_temp_cooldown", 0.99995)
server.set("p_new_proposal", 0.1)
server.set("min_proposed", 0.001)

server.set("critic_weight", 1)
server.set("proposed_v_weight", 0.01)
server.set("proposed_entropy_weight", 0.0001)
